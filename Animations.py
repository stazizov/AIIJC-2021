...
class QRoundProgressWidget(QtWidgets.QWidget):
    def __init__(self):
        super(type(self), self).__init__()

        self.bar = QRoundProgressBar()
        self.bar.setFixedSize(200, 200)
        self.bar.setStyleSheet('background : rgba(235, 235, 235, 250)')

        self.bar.setDataPenWidth(0)
        self.setMinimumSize(720, 480)
        self.bar.setOutlinePenWidth(0)
        self.bar.setDonutThicknessRatio(0.75)
        self.bar.setDecimals(0)
        self.bar.setFormat(' %p %')
        self.bar.setNullPosition(90)
        self.bar.setBarStyle(QRoundProgressBar.StyleDonut)
        self.bar.setDataColors([(0., QtGui.QColor.fromRgb(50, 110, 170)), 
                                (0.25, QtGui.QColor.fromRgb(50, 170, 170)),
                                (0.5, QtGui.QColor.fromRgb(50, 110, 170)),
                                (0.75, QtGui.QColor.fromRgb(150, 110, 170)), 
                                (1., QtGui.QColor.fromRgb(50, 110, 170))])
